...
#		print (value[1:])
	...
	def calibrate(self):
		...
		max_sensor_values = [-float('inf')] * self.numSensors
		min_sensor_values = [float('inf')] * self.numSensors
		...
		self.calibratedMin = min_sensor_values
		self.calibratedMax = max_sensor_values
